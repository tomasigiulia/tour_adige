...
(function() {
  ...
  var scenes = data.scenes.map(function(data) {
    var source = Marzipano.ImageUrlSource.fromString(
      "./panorami/" + data.id + ".jpg"
    );
    var geometry = new Marzipano.EquirectGeometry(data.levels);

    var limiter = Marzipano.RectilinearView.limit.traditional(data.faceSize, 120*Math.PI/180, 30*Math.PI/180);
  ...
  // Bind click event to scene list elements.
